...
def estimate_cmle(instances):
    ...
    # Call the model
    model_url = 'projects/rare-result-248415/models/tweet_sentiment_classifier'
...
class MyOptions(PipelineOptions):
    ...
    def _add_argparse_args(cls, parser):
        parser.add_argument(
            ...
            default="projects/rare-result-248415/subscriptions/got-tweets-subscription-alexis"
        )
...
def run(argv=None):
    ...
    google_cloud_options.project = 'rare-result-248415'
    google_cloud_options.staging_location = 'gs://twitter-pipeline-new/staging'
    google_cloud_options.temp_location = 'gs://twitter-pipeline-new/temp'
