...
if __name__ == '__main__':
    ...
    parser.add_argument('--input-data-uri', dest='input-data-uri', type=str, help='Training data GCS or BQ URI set during Vertex AI training.')
    parser.add_argument('--uri_data', dest='validation-data-uri', type=str, help='embbeding data GCS or BQ URI set during Vertex AI training.')
